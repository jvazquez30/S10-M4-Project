...
export default function TodoForm() {
  ...
  const [ createQuote, {error: createError, isLoading: creatingQuote } ] = useCreateQuoteMutation()
  ...
  return (
    <form id="quoteForm" onSubmit={onNewQuote}>
      <h3>New Quote {createError && createError.data.message} {creatingQuote && ' being created'} </h3>
